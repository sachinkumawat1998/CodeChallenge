...
.PHONY: all shell build build-node coverage-node coverage-django coverage docker help load_initial_data migrate quality setup superuser test-node test-django test install-npm-dependencies runserver makemigrations eslint lint-django lint-django-fix
